...
impl<'ast, 'f> TypeCheckerPass<'ast, 'f> {
    pub fn new(function_map: &'f mut FxHashMap<Handle, FunctionInfo<'ast>>, scope_reference_map: &'f ScopeReferenceMap, semantic_error_list: &'f mut SemanticErrorList) -> Self {
        Self {
